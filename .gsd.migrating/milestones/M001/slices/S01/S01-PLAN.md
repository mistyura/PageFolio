...
- [x] **T01: requirements.txt 整備** `est:10m`
...
- [x] **T02: constants.py 拡張子定数・LANG キー追加** `est:20m`
...
- [x] **T03: file_ops.py ファイルダイアログ・保存フロー変更** `est:30m`
...
- [x] **T04: app.py D&D フィルター拡張** `est:20m`
