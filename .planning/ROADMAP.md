...
**Plans**: 4 plans（01-01〜03 complete + 01-04 gap-closure）
**Wave 1**
...
- [ ] 01-04-PLAN.md — _confirm_cost / _confirm_summary_cost に runpod 分岐追加（send-to ホスト/モデルの誤開示 CR-01 解消）+ _provider_display_name の runpod 表示名（WR-02）+ 送信先開示の回帰テスト（Wave 4）
...
|-------|-----------|----------------|--------|-----------|
| 1. Undo/Redo 修正 | v1.3.0 | 3/3 | Complete   | 2026-07-04 |
