...
- [ ] 03-03-PLAN.md — 遡及 human-verify/UAT の対象確定・実機確認 3 分割・結果記録
- [ ] 03-04-PLAN.md — リリース版数文書の 3 点同期（APP_VERSION / README バッジ / 開発履歴.md）
...
| 3. API 整理と回帰テスト | v1.3.0 | 2/4 | In Progress|  |
