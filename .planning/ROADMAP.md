...
- [x] **Phase 2: プレビュー最適化とリファクタリング** - プレビューのフルシリアライズ廃止、dialogs / constants の分割 (completed 2026-06-03)
...
- [x] 01-03-PLAN.md — 挿入 Undo/Redo 内容同一性テスト・全 op 往復の安全網テスト（TEST-01）
...
- [x] 02-01-PLAN.md — プレビュー同期化・純関数 _render_preview_pixmap 抽出・回帰テスト（BUG-03 / TEST-02）
- [x] 02-02-PLAN.md — constants.py を themes.py / lang.py に分割し再エクスポートで後方互換維持（REFAC-02）
- [x] 02-03-PLAN.md — dialogs.py を pagefolio/dialogs/ サブパッケージへ分割（REFAC-01）
