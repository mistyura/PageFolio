...
- [x] **V190-QA-01**: Tkinter 実行環境の問題（Python 3.14.6 での GUI テストのセットアップエラー）を切り分け・修復し、GUI テストを含む全テストが完走する。完走をリリースゲート条件とする
- [x] **V190-QA-02**: 保存トーストの再試行を実行した際、上書き確認・保存先選択を再表示せず、前回確定した対象へ黙って再保存する（IN-01・v1.8.0 Phase 6 持ち越し / D-09・D-12 により文言訂正）
- [x] **V190-QA-03**: 実機目視による human-verify / UAT を正式に実施し、結果を記録する（v1.4.0 / v1.6.0 / v1.7.1 で一旦 pass とした項目の正式消化）
...
| V190-QA-01 | Phase 3 | Complete |
| V190-QA-02 | Phase 3 | Complete |
| V190-QA-03 | Phase 3 | Complete |
