...
LANG = {
    "ja": {
        ...
        "ocr_force_vision": "埋め込みテキストを無視して OCR を実行（スキップしない）",
    ...
    "en": {
        ...
        "ocr_force_vision": "Ignore embedded text and always run OCR (no skip)",
        ...
        "ocr_custom_prompt_md": (
            "Render OCR results as Markdown (when custom prompt is set)"
        ),
